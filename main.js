...
function addTask(projectIndex) {
  let taskName = document.getElementById(`taskName-${projectIndex}`).value;
  if (taskName === "") {
  ...
  displayProjects();
  document.getElementById(`taskName-${projectIndex}`).value = "";
}
...
function displayProjects() {
  ...
  projectList.forEach((project, index) => {
    ...
    taskInput.setAttribute("id", `taskName-${index}`);
    ...
    taskInputContainer.appendChild(taskButton);
    projectElement.appendChild(taskInputContainer);
